				...
				<div class="card blue-grey lighten-4">
					<div class="card-content">
						...
						<div class="col s12 m12 l12">
							<div class="card blue-grey lighten-4 contenedor_scroll">
								<div class="card-content">
...
?>
						...
						<a class="waves-effect waves-light btn-small blue-grey lighten-1" type="submit" id="aceptar" onclick="confirmar_uea()">Confirmar</a>
						<br><br>
						<a class="waves-effect waves-light btn-small blue-grey lighten-1" type="submit" id="aceptar" onclick="inscripcion_blanco()">En Blanco</a>
